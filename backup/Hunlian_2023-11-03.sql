...
CREATE TABLE `chatroom` (
  ...
  `chat_users_id` text COLLATE utf8mb4_unicode_520_ci NOT NULL COMMENT '用户 IDs',
  `chat_ip` varchar(15) COLLATE utf8mb4_unicode_520_ci NOT NULL COMMENT 'IP',
...
INSERT INTO `chatroom` (`id`, `chat_id`, `chat_name`, `chat_description`, `chat_users_id`, `chat_ip`, `type`, `status`, `created_at`, `modified_at`, `deleted_at`)
VALUES
	(1,'8be9e13c-bf6e-4145-996c-f3d8818221d4','测试交流','Hello World','hl_a90915530','127.0.0.1',0,1,'2022-09-08 10:22:02','2022-10-06 18:39:37',NULL);
...
VALUES
	(1,'8be9e13c-bf6e-4145-996c-f3d8818221d4','hl_a90915530','Hi','text',0,NULL,1,'2023-11-03 15:32:30',NULL,NULL),
	(2,'8be9e13c-bf6e-4145-996c-f3d8818221d4','hl_a90915530','您好','text',0,NULL,1,'2023-11-03 15:34:30',NULL,NULL),
	(3,'8be9e13c-bf6e-4145-996c-f3d8818221d4','hl_a90915530','didi','text',0,NULL,1,'2023-11-03 15:34:55',NULL,NULL),
	(4,'8be9e13c-bf6e-4145-996c-f3d8818221d4','hl_a90915530','biu','text',0,NULL,1,'2023-11-03 18:09:34',NULL,NULL);
...
VALUES
	(25,2,'hl_a90915530','KMT 184.05','/uploads/files/TGgCSHkqsLstgkne0FuewabXMyGIrjE9.jpg','1997-02-01',173,1,'{\"key\":\"zhipin\",\"value\":[0,12]}','[\"/uploads/files/fWb1balGB2IQSWdccNXPVR44wFpyyBcR.png\",\"/uploads/files/pkfG33cwtPa2HiKpkdRhuqwufkCZaZV3.png\"]',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'op02s4vhiiLffHPfdB7LKmpMdr_I',NULL,NULL,'10.0.8.14','2023-11-03 18:18:31','2023-10-24 17:48:25','2023-10-24 17:50:28',NULL),
