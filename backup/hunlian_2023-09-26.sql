...
INSERT INTO `customer` (`id`, `user_wechat_open_id`, `relation`, `relation_id`, `introduction`, `json`, `created_at`, `modified_at`, `deleted_at`)
VALUES
	(2,'1op02s4vhiiLffHPfdB7LKmpMdr_I',0,1126638303,'介绍性的内容',NULL,'2023-09-22 17:35:03','2023-09-22 17:35:03',NULL),
	(3,'test-1234',0,1126638303,'didididiididid',NULL,'2023-09-22 17:35:03','2023-09-22 17:35:03',NULL);
...
INSERT INTO `users` (`id`, `type`, `user_id`, `nickname`, `avatar_url`, `birthday`, `height`, `sex`, `work`, `photos`, `videos`, `detail`, `contact`, `location`, `realname`, `number`, `wechat_union_id`, `wechat_open_id`, `wechat_platform_open_id`, `parent_id`, `ip`, `created_at`, `modified_at`, `deleted_at`)
VALUES
	(2,1,'10000001','Jiangkun','/uploads/files/c9WyMZmT3nl6QKrXhNivsFAvMcv7MPBd.png','2001-03-01',174,1,'房地产/建筑','[\"/uploads/files/4Yk9GYRHwbJCubuPNhCc2UL0XkfYymq0.png\",\"/uploads/files/S1O8rRym4gBMYniWqGwnHub7UtDkAGJT.png\"]',NULL,'Hi 你好哇~',NULL,NULL,NULL,'17725386753',NULL,'1op02s4vhiiLffHPfdB7LKmpMdr_I',NULL,NULL,NULL,'2023-09-22 08:03:17','2023-09-22 08:03:32',NULL),
	(3,1,'10000002','☄️ 彗星撞地球','/uploads/files/10000002.png','1998-05-10',173,0,'教育',NULL,NULL,'爱笑开朗乐观，对你充满期待',NULL,NULL,NULL,NULL,NULL,'test-1234',NULL,NULL,NULL,'2023-09-24 21:51:03','2023-09-24 21:51:03',NULL);
